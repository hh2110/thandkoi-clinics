...
| 19 | [Upcoming events card (The Family Network feedback, July 2026)](19-family-network-feedback-2026-07.md) — home-page "upcoming events" card, no page/model exists yet, tied to a real deadline (2026-08-06 camp). The rest of that WhatsApp feedback round (About/founders teaser, expandable Contact/Zakat, housekeeping) is already done/merged and no longer tracked here. Design pass in progress | 📝 Drafted |
