...
| 12 | [Generic report stats & flexible key figures](12-generic-report-stats.md) — replace `CampReportPage`'s hardcoded Paediatrics/General/Welfare split with a flexible key-figure block + document attachment, so the Camp Reports archive can hold any one-off report (medical camp or institutional event), not just camps | 📝 Drafted |
